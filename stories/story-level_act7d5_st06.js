var story = [
    ...
    [
        ...
        "playground.drawCharacter({name:'char_123_fang_1',name2:'char_130_doberm_ex',focus:1});playground.drawDialog({name:'杜宾',text:'对了，你也是玻利瓦尔出身，我记得是移民去了哥伦比亚吧。'});",
        "playground.drawCharacter({name:'char_123_fang_1',name2:'char_130_doberm_ex',focus:2});playground.drawDialog({name:'芬',text:'嗯，我也只是从我父母那里听说了玻利瓦尔的情况，所以有些好奇。'});",
        "playground.drawDialog({name:'芬',text:'啊，请不要误会，我不是为了知道这个才......'});",
        "playground.drawCharacter({name:'char_123_fang_1',name2:'char_130_doberm_ex',focus:2});playground.drawDialog({name:'杜宾',text:'没关系，即使你真的为了这个而来也很正常......'});",
        "playground.drawCharacter({name:'char_130_doberm_ex'});playground.drawDialog({name:'杜宾',text:'米格鲁，过来帮我拉住被套。'});",
